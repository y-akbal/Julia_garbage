...
function iterate(A::Array{Float32,2}, B::Array{Float32,2}, n::Int64, lr::Float32)
...
@time B = iterate(A, B, 100, 0.1f0) ### if you are lucky and adjust the right learning rate you will get the inverse of A, even can see smurfs if stay calm for a while.
